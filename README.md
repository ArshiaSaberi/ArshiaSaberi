<img align="center" src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&duration=3000&pause=1000&color=green&center=true&vCenter=true&width=435&lines=Hi🖐+I'm+Arshia+Saberi😎;Front-end+Developer&nbsp🧑‍💻;React+%7C+TypeScript+%7C+Redux+Toolkit+Expert&nbsp👨‍💻" alt="Typing SVG" />
<hr>
...
توسعه‌دهنده فرانت‌اند با **React.js** و **Next.js**
<br>&nbsp;

🔭 در حال کار با: React, TypeScript, TailwindCSS, Redux Toolkit, React Query

💡 همیشه در حال یادگیری و به‌روزرسانی دانش فنی

🌱 در حال یادگیری و کار با: Next.js, React Hook Form, Formik, Styled Components, Jest, WebSocket

💻 تخصص اصلی: توسعه فرانت‌اند و مدیریت state
...
[![Formik](https://img.shields.io/badge/Formik-3C78F0?style=for-the-badge&logo=formik&logoColor=white)](https://formik.org/)
...
🌐 Personal Website: <a href="https://arshiasaberi.github.io/arshiasaberiproject/" target="_blank">وبسایت شخصی</a>
